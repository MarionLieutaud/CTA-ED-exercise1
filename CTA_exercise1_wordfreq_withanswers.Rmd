---
title: "Computational Text Analysis - Exercise 1: Word frequency analysis"
...
View(edbfdata) # you may need to install XQuartz to use this function. You can install it from the following link: https://www.xquartz.org/
```
