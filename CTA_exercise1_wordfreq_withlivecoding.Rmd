...
str_view(head(edbfdata$description), "<p>\\n\\t|<\\/p>|\\>")



str_view(edbfdata$description, "[gG]ender")


str_detect(edbfdata$description, "<p>\\n\\t")
str_view(head(edbfdata$description), "<p>\\n\\t")
```
